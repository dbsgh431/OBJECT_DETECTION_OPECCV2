...
class BackgroundExtracion:
    ...
    def apply(self, frame) :
        ...
        abs_diff = cv2.absdiff(bg_buffer.get_backgrond(),gray)
...
class Game:
    def __init__(self, width, height, size=50):
        ...
        self.height = height
        self.size = size
        self.logo = cv2.imread("data3/logo.png")
...
bg_buffer = BackgroundExtracion(width,height,scale,maxlen=5)
